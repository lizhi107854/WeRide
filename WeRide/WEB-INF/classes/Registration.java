...
//            usertype = request.getParameter("userType");
        ...
        if (!password.equals(repassword)) {
            ...
            if (hm.containsKey(username))
                ...
                MySqlDataStoreUtilities.insertUser(username, password, repassword,email,number,trueName,CVV,date);
    ...
    protected void displayRegistration(HttpServletRequest request,
        ...
        pw.print("<form method='post' action='Registration'>"
                ...
                + "</td></tr><tr><td>"
                + "<h3>Credit Card Number</h3></td><td><input type='cardNumber' name='number' value='' class='input' required></input>"
                + "</td></tr><tr><td>"
                + "<h3>Name On Card</h3></td><td><input type='trueName' name='trueName' value='' class='input' required></input>"
                + "</td></tr><tr><td>"
                + "<h3>CVV</h3></td><td><input type='CVV' name='CVV' value='' class='input' required></input>"
                + "</td></tr><tr><td>"
                + "<h3>Expiration Date</h3></td><td><input type='date' name='date' value='' class='input' required></input>"
                + "</td></tr><tr><td>"

...
public class SubmitReview extends HttpServlet {
    ...
    protected void storeReview(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            String rate = request.getParameter("Driver Rating");
            String text = request.getParameter("reviewtext");
            String date = request.getParameter("reviewdate");
            String username = (String) session.getAttribute("username");
            String message = utility.storeReview(username,orderId, driverName, rate,date, text);
...
//                pw.print("<br><br><br>");
                pw.print("<h2>Review has been Stored </h2>");
            }
            else {
//                pw.print("<br><br><br>");

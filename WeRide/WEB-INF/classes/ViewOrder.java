...
//		pw.print("<div style='background-color:lightblue;>");
		pw.print("<form style='background-color:lightblue; height=1000'name ='ViewOrder' action='ViewOrder' method='get'>");
		...
		{
			pw.print("<table border ='0' align='center' height ='300' width='400' ><tr><td align='center' style='font-size:30px'>Enter OrderNo &nbsp&nbsp<input name='orderId' type='text'></td></tr>");
//			pw.print("<br><br><br><br><br><br>");
			pw.print("<tr><td style='font-size:30px' align='center'><input type='submit' name='Order' value='ViewOrder' class='btnbuy'></td></tr></table>");
		}
...
//					pw.print("<div style='background-color:lightblue; height:100%'>");
					pw.print("<table border = '0' align='center' height ='500' width='400'>");
					pw.print("<tr style='font-size: 24px;'>");
					...
					pw.print("<th>User Name:</th>" +
							...
							"</tr>");
					pw.print("<tr style='font-size: 24px;'>");
					pw.print("<th>Driver:</th>" +
							"<th>" + oi.getDriver() + "</th>" +
							"</tr>");
					pw.print("<tr style='font-size: 24px;'>");
					pw.print("<th>Car Model:</th>" +
							"<th>" + oi.getCar() + "</th>" +
							"</tr>");
					pw.print("<tr style='font-size: 24px;'>");
					pw.print("<th>From:</th>" +
							"<th>" + oi.getPickUp_Location() + "</th>" +
							"</tr>");
					pw.print("<tr style='font-size: 24px;'>");
					pw.print("<th>To:</th>" +
							"<th>" + oi.getDropOff_Location() + "</th>" +
							"</tr>");
					pw.print("<tr style='font-size: 24px;'>");
					pw.print("<th>Price:</th>" +
							"<th>" + oi.getOrderPrice() + "</th>" +
							"</tr>");
					pw.print("<tr style='font-size: 24px;'>");
					pw.print("<th>Distance:</th>" +
							"<th>" + oi.getDistance() + "</th>" +
							"</tr>");
					pw.print("<tr style='font-size: 24px;'>");
					pw.print("<th>Drop Off Time:</th>" +
							"<th>" + oi.getDrop() + "</th>" +
							"</tr>");
					pw.print("<tr>");
					pw.print("<td><input style='font-size: 24px;' align='center' type='submit' name='Order' value='CancelOrder' class='btnbuy'></td>");
					pw.print("</tr>");
					pw.print("</table>");
			...
			{	pw.print("<div align='center' height = '500' >");
				pw.print("<br><br><br><br><br><br>");
				pw.print("<h1 style='color:red'>You have not placed any order with this order id</h1>");
				pw.print("</div>");
			}
		}
...
//			String orderId=request.getParameter("orderName");
//			if(request.getParameter("oderId") != null)
//			{
			int orderId = 0;
